...
-- [[ Basic Keymaps ]]
--  See `:help vim.keymap.set()`vim.keymap.set('n', '<leader>n', ':NERDTreeFocus<CR>')
...
vim.keymap.set('n', '<leader>rr', '<cmd>NERDTreeRefreshRoot<CR>', { desc = 'Refresh NerdTree Root' })
...
require('lazy').setup({
  ...
  },
  {
    ...
    lazy = false,
    dependencies = {
      'kevinhwang91/promise-async', -- Only needed if you want to use sesssion lens
    },
    config = function()
      require('auto-session').setup {
